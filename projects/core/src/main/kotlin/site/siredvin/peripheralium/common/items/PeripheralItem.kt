...
open class PeripheralItem(properties: Properties, private var enableSup: Supplier<Boolean>, private vararg val tooltipHook: Function<PeripheralItem, Component?>) : DescriptiveItem(properties) {
