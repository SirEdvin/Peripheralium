...
class LibENLanguageProvider(
    output: PackOutput,
) : LanguageProvider(output, PeripheraliumCore.MOD_ID, "en_us", LibPlatform.holder, *LibTexts.values()) {
    override fun addTranslations() {
        ...
        add(LibTexts.CREATIVE_TAB, "Peripheralium")
        add(LibTexts.PRESS_FOR_DESCRIPTION, "[§3Left shift§r] show description")
    }
}
