...
object LibLootTableProvider {
    fun getTables(): List<Pair<Consumer<BiConsumer<ResourceLocation, LootTable.Builder>>, LootContextParamSet>> = listOf(
        Pair(Consumer { registerBlocks(it) }, LootContextParamSets.BLOCK)
    )
