...
class LibUALanguageProvider(
    output: PackOutput,
) : LanguageProvider(output, PeripheraliumCore.MOD_ID, "uk_ua", LibPlatform.holder, *LibTexts.values()) {
    override fun addTranslations() {
        ...
        add(LibTexts.CREATIVE_TAB, "Перифераліум")
        add(LibTexts.PRESS_FOR_DESCRIPTION, "[§3Left shift§r] показити опис")
    }
}
