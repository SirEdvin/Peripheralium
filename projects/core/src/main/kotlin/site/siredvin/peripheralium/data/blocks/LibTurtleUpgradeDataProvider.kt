...
abstract class LibTurtleUpgradeDataProvider(output: PackOutput, serializers: List<TurtleUpgradeSerialiser<*>>) : TurtleUpgradeDataProvider(output) {
    private val serializers: List<ResourceLocation> = serializers.map(XplatRegistries.TURTLE_SERIALIZERS::getKey)
