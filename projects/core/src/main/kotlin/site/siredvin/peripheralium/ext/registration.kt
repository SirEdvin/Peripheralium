...
fun <T: Item> T.register(name: String): T {
    Registry.register(Registry.ITEM, ResourceLocation(PeripheraliumCore.MOD_ID, name), this)
    return this
}

fun <T: Block> T.register(name: String, itemFactory: (Block) -> (Item) = { block -> DescriptiveBlockItem(block, Item.Properties()) }): T {
    Registry.register(Registry.BLOCK, ResourceLocation(PeripheraliumCore.MOD_ID, name), this)
    Registry.register(Registry.ITEM, ResourceLocation(PeripheraliumCore.MOD_ID, name), itemFactory(this))
    return this
}
