...
interface SlottedItemStorage :
    ...
    override fun moveTo(to: ItemSink, limit: Int, toSlot: Int, takePredicate: Predicate<ItemStack>): Int = moveTo(to, limit, -1, toSlot, takePredicate)
}
