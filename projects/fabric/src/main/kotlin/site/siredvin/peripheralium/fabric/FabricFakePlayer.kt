...
class FabricFakePlayer(serverLevel: ServerLevel, owner: Entity?, gameProfile: GameProfile) : LegacyLibFakePlayer(serverLevel, owner, gameProfile) {
    ...
    companion object {
        fun create(serverLevel: ServerLevel, profile: GameProfile): FabricFakePlayer {
            ...
            val fakePlayer = FabricFakePlayer(serverLevel, currentPlayer, profile)
