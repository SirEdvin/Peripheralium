...
class ExperienceAbility(val owner: IPeripheralOwner, private val interactionRadius: Int) :
    IOwnerAbility,
    IPeripheralPlugin {
    companion object {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return owner == other.owner && interactionRadius == other.interactionRadius
    }
