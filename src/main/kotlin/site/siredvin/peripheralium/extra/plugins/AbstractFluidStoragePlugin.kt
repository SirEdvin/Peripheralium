...
abstract class AbstractFluidStoragePlugin(protected val level: Level) : IPeripheralPlugin {
    companion object {
        const val FORGE_COMPACT_DEVIDER = 81.0
        const val PLUGIN_TYPE = "fluid_storage"
    }

    abstract val storage: Storage<FluidVariant>
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is AbstractFluidStoragePlugin) return false
